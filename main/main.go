...
func handleConnection(conn *websocket.Conn) {
	...
	containerID, err := dockerClient.CreateAndStartContainer(image, cmd)
	if err != nil {
	...
	execID, err := dockerClient.CreateExecInstance(containerID, cmd)
	if err != nil {
	...
	defer func() {
		if err := dockerClient.StopAndRemoveContainer(containerID); err != nil {
